...
botonMultiplicacion.addEventListener('click', clickMutiplicacion)
...
botonReset.addEventListener('click', clickReset)
...
Mousetrap.bind('*', clickMutiplicacion)
